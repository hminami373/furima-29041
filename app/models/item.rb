class Item < ApplicationRecord
  ...
  #空の投稿を保存できないようにする
  validates :image, :item_name, :item_info, :item_category_id, :item_sales_status_id, :item_shipping_fee_status_id, :prefecture_id, :item_scheduled_delivery_id, :item_price,  presence: true
